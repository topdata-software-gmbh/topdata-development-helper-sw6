...
namespace Topdata\TopdataDevelopmentHelperSW6\Helper;
...
use Topdata\TopdataDevelopmentHelperSW6\Util\UtilArray;
use Topdata\TopdataDevelopmentHelperSW6\Util\UtilString;
